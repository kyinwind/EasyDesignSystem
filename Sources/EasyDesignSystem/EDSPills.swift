...
public struct EDSPillTone: Sendable {
    ...
    public static let defaultPalette: [EDSPillTone] = [
        EDSPillTone(background: Color(hexRGB: "#EAF2FF"), foreground: Color(hexRGB: "#246BCE")),
        EDSPillTone(background: Color(hexRGB: "#EAF8F0"), foreground: Color(hexRGB: "#218B4E")),
        EDSPillTone(background: Color(hexRGB: "#FFF4E6"), foreground: Color(hexRGB: "#B76100")),
        EDSPillTone(background: Color(hexRGB: "#F3EDFF"), foreground: Color(hexRGB: "#6F42C1")),
        EDSPillTone(background: Color(hexRGB: "#EAF7FA"), foreground: Color(hexRGB: "#087990")),
        EDSPillTone(background: Color(hexRGB: "#FDECEF"), foreground: Color(hexRGB: "#C7354D")),
        EDSPillTone(background: Color(hexRGB: "#FFF0F7"), foreground: Color(hexRGB: "#B83280")),
        EDSPillTone(background: Color(hexRGB: "#EEF2FF"), foreground: Color(hexRGB: "#4F46E5")),
        EDSPillTone(background: Color(hexRGB: "#ECFDF5"), foreground: Color(hexRGB: "#047857")),
        EDSPillTone(background: Color(hexRGB: "#FEFCE8"), foreground: Color(hexRGB: "#A16207")),
        EDSPillTone(background: Color(hexRGB: "#F1F5F9"), foreground: Color(hexRGB: "#475569")),
        EDSPillTone(background: Color(hexRGB: "#F0FDFA"), foreground: Color(hexRGB: "#0F766E"))
    ]
}
...
public enum EDSPillFlowSortOrder: Sendable {
    /// 保持调用方传入顺序。
    case original
    /// 按字符串本地化升序排序。
    case ascending
...
public struct EDSPillFlow: View {
    ...
    public init(
        ...
        self.palette = palette.isEmpty ? EDSPillTone.defaultPalette : palette
        self.showsRemoveButton = showsRemoveButton
        self.onTap = onTap
        self.onRemove = onRemove
    }
    ...
    private func tone(at index: Int) -> EDSPillTone {
