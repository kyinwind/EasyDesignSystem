...
///
/// `EDSSection` is designed to logically group your settings rows (like toggles, actions, and links)
...
/// }
/// ```
public struct EDSSection<Content: View, Header: View, Footer: View>: View {
...
public extension EDSSection where Footer == EmptyView {
...
public extension EDSSection where Header == EmptyView {
...
public extension EDSSection where Header == EmptyView, Footer == EmptyView {
...
public extension EDSSection where Header == Text, Footer == EmptyView {
...
public extension EDSSection where Header == EmptyView, Footer == Text {
...
public extension EDSSection where Header == Text, Footer == Text {
...
public extension EDSSection where Header == Text {
